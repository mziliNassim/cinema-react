      ...
      <div className="min-h-[85vh] flex items-center justify-center p-2">
        ...
        >
          ...
          <p className="mb-5 font-semibold text-gray-300 text-balanc">
            Alredy Have Acount{" "}
            <Link to="/user/login" className="underline text-cyan-800">
              Sign in
            </Link>
          </p>
          {/* name */}
          <div className="grid md:grid-cols-2 md:gap-6 md:mb-8">
            {/* first_name */}
            <div className="relative z-0 w-full mb-8 md:mb-0 group">
              <input
                type="text"
          ...
          {/* Submit Button */}
          <div className="w-full group text-end">
            <button
              type="submit"
              className="text-white bg-cyan-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-cyan-400 dark:hover:bg-cyan-700 dark:focus:ring-bg-cyan-800"
            >
              Sign Up
            </button>
          </div>
